  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        displayCurrencyHint: 'Only changes the currency symbol shown on recharge/subscription pages; it does not change the provider settlement currency',
        displayCurrencyUsd: 'US Dollar $',
        displayCurrencyCny: 'Chinese Yuan ￥',
